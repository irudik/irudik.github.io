...
\begin{itemize} % Reduce space between items
	...
	\item[] The Long Run Distributional Effects of Climate Change (with Tianzi Liu, Zebang Xu)
	\item[] \href{https://ivanrudik.com}{The Social Value of Hurricane Forecasts} (with Renato Molina, conditionally accepted at \textbf{American Economic Journal: Economic Policy})
\end{itemize}
...
\paragraph{Current:} \textit{Virginia Callison}$^\Upsilon$; \textit{Chrisma D'Souza}$^\Upsilon$; \textit{Luc Esprabens}$^\Upsilon$; \textit{Tianzi Liu}$^\Upsilon$;\textit{Antonia Marcheva}$^\Upsilon$; Dean Arnold; Bingyan Dai; Victor Simoes Dornelas, Yurou He; Zhiren Hu; Jack Ma; Tianjiao Mei; Jeisson Prieto; Zebang Xu; Terry Zhang; Yongfan Zhao
\vspace{-.35in}
