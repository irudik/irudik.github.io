...
\begin{itemize}
	\item[] Lade, G. and I. Rudik. 2020. \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3086728}{Costs of Inefficient Regulation: Evidence from the Bakken}. \textbf{Journal of Environmental Economics and Management}.
...
\begin{itemize} % Reduce space between items
	\item[] Conservation Co-Benefits from Pollution Regulation (with Yuanning Liang, Eric Zou, and Catherine Kling)
...
\paragraph{2020} Penn State, IZA Workshop on Environment Health and Labor Markets, WEAI Presidental Session (discussant), AERE, Global Open Seminar on Environmental Economics, NBER EEE Spring, Cornell Lab of Ornithology, ASSA (presenter, discussant) \vspace{-.3in}
...
\begin{itemize}
	...
	\vspace{-0.05in}
	\begin{itemize} \itemsep -1pt
		\item[] Mike Huang \hfill Expected 2024
		\item[] Weiliang Tan \hfill Expected 2023
	...
	\vspace{-0.05in}
	\begin{itemize} \itemsep -1pt
		\item[] Muye Chen (Economics) \hfill Expected 2022
...
\begin{itemize}
	...
	\vspace{-0.05in}
	\begin{itemize} \itemsep -1pt
		\item[] Haotian Wu \hfill Expected 2021
		\item[] Jinge Li - Yale Environmental and Natural Resource Economics Ph.D. \hfill Expected 2020
	...
	\vspace{-0.05in}
	\begin{itemize} \itemsep -1pt
		\item[] Marley Bonacquist-Currin - Cornell Natural Resources Ph.D. \hfill Expected 2020
		\item[] Yikuan Ji - Maryland AREC Ph.D. \hfill Expected 2020
		\item[] Louis Chua (Regional Science) \hfill Expected 2020
		\item[] Congyan Han - Wisconsin Urban Land Economics Ph.D. \hfill 2019
	\end{itemize}
\end{itemize}
\vspace{-.075in}
