...
\paragraph{2023} Richmond Fed Climate Miniconference, AERE, Stanford Preparing for Climate Change Conference, Chicago EPIC Junior Workshop, Colgate University, Kansas City Fed, St. John's University 
...
\paragraph{Current:} \textit{Luc Esprabens}$^\Upsilon$; \textit{Mike Huang}$^\Upsilon$; \textit{Antonia Marcheva}$^\Upsilon$; \textit{Weiliang Tan}$^\Upsilon$; Bingyan Dai; Emiliano Harris
\vspace{-.35in}
...
\paragraph{2023:} \textit{Virginia Callison$^\Upsilon$}, Tianzi Liu (Cornell Dyson Ph.D.), Tianjiao Mei (Cornell Dyson Ph.D.)
\vspace{-.53in} 
...
\paragraph{2023:} \textit{Chen-Ti Chen$^\Upsilon$ (Ohio State AEDE)}

\vspace{-.2in}

\subsubsection{Undergraduate}\vspace{-.2in}
\paragraph{2023:} \textit{Alan Cui$^\Upsilon$}\vspace{-.4in}
\paragraph{2021:} \textit{Angela Zeng$^\Upsilon$  (Duke Nicholas M.E.M.)}
