...
% bin/deploy --user
\documentclass[11pt]{res} % Use the res.cls style
...
\subsection{Academic Appointment}
	...
	\item[] Cornell University: Dyson School of Applied Economics and Management
		...
		\begin{itemize} \itemsep -1pt
			\item[] \,\,\,\, Kenneth L. Robinson Professor of Applied Economics and Public Policy \hfill 2026--
...
\begin{itemize}
	\item[] Molina, R. and I. Rudik. Forthcoming. \href{https://www.nber.org/papers/w32548}{The Social Value of Hurricane Forecasts}. \textbf{American Economic Journal: Economic Policy}.
	\item[] Wolfram, C., J. Aldy, C. Bracher, G. Casey, V. Chaturvedi, K. Clausing, C. Fischer, C. Gollier, A. Hsiao, F. Jotzo, M. Medeiros, K. Meng, A. Muthitacharoen, A. Ockenfels, M. Pangestu, M. Pereboom, A. Rao, I. Rudik, D. Sembene, N. Shimberg, E. Somanathan, D. Tingley, and J. Winter. 2026. \href{https://www.science.org/doi/abs/10.1126/science.aef7190}{Building a Scalable Climate Coalition for Heavy Industry}. \textbf{Science} 393(6815):984--987.
	\item[] Liu, T., I. Rudik, Z. Xu. 2026. \href{https://pubs.aeaweb.org/doi/pdfplus/10.1257/pandp.20261025}{Climate Change and Long Run Factor Shares.} \textbf{AEA Papers and Proceedings} 116:510–516.
	\item[] Hollingsworth, A., T. Jaworski, C. Kitchens, I. Rudik. 2026. \href{https://www.journals.uchicago.edu/doi/10.1086/735784}{Economic Geography and Air Pollution Regulation in the United States}. \textbf{Journal of Political Economy: Microeconomics} 4(1)38--77.
...
\begin{itemize} % Reduce space between items
	\item[] \href{https://www.dropbox.com/scl/fi/jqjg9903c2m97kyagmh1r/CaseyMengRudik_carbon_tariffs.pdf?rlkey=vt1jja2dxgrqatmszyr10yajs&dl=1}{Are Carbon Tariffs Climate Policy?} (with Gregory Casey, Kyle C. Meng)
	...
	\item[] \href{https://www.nber.org/papers/w35682}{Pollution Pricing in Equilibrium: Production, Reallocation, and Aggregate Impacts} (with R. Andrew Butters, Jackson Dorsey)
\end{itemize}
...
\paragraph{2027} Carnegie Mellon/Pittsburgh \vspace{-.3in}
\paragraph{2026} ASSA (discussant 2x, presenter), University of Nevada - Reno, Tulane University \vspace{-.3in}
\paragraph{2025} Toulouse School of Economics, London School of Economics, Paris School of Economics, Rochester Institute of Technology Annual Viehe Lecture Series \vspace{-.3in}
\paragraph{2024} Global Inequalities in Weather Forecasts, NBER EEPE Conference, UC Santa Barbara, ASSA (presenter, discussant) \vspace{-.3in}
\paragraph{2023} University of Arizona, Arizona State University, Richmond Fed Climate Miniconference, Northeast Workshop on Energy Policy and Environmental Economics, AERE, Stanford Preparing for Climate Change Conference, Kansas City Fed, St. John's University \vspace{-.3in}
\paragraph{2022} Arizona State University, Santa Clara University, University of Miami, Colorado Environmental Workshop, University of Colorado, University of Illinois, Indiana University, Georgetown, CESifo Area Conference on Energy and Climate Economics, Duke-NCSU-TREE, Oregon State, ASSA \vspace{-.3in}
...
\begin{itemize} \itemsep -1pt
	\item[] AERE Nominating Committee \hfill 2026--
...
\begin{itemize} \itemsep -1pt
	\item[] College Faculty Policy Committee \hfill 2026--2029
	\item[] Dyson Strategic Plan Steering Committee \hfill 2026--2027
	\item[] IAHC Committee Chair \hfill 2025
	\item[] Area Composition Review Committee \hfill 2025--2026
...
\subsection{Awards}
\begin{itemize} \itemsep -1pt
	\item[] JAERE Excellence in Refereeing Award \hfill 2026
...
\paragraph{Current:} \textit{Virginia Callison}$^\Upsilon$; \textit{Chrisma D'Souza}$^\Upsilon$; \textit{Luc Esprabens}$^\Upsilon$; \textit{Tianzi Liu}$^\Upsilon$; Bingyan Dai; Victor Simoes Dornelas, Yurou He; Zhiren Hu; Tianjiao Mei; Jeisson Prieto; Zebang Xu; Terry Zhang; Yongfan Zhao
\vspace{-.35in}
\paragraph{2026:} \textit{Antonia Marcheva$^\Upsilon$ (Paris School of Economics Postdoc)}; Dean Arnold (Calgary Postdoc); Jack Ma (CUHK Shenzhen)
\vspace{-.35in}
\paragraph{2025:} \textit{{Mike Huang}$^\Upsilon$ (Freddie Mac)}; \textit{Weiliang Tan$^\Upsilon$ (NBER Postdoc \& Claremont McKenna College)}; Emiliano Harris (Utah Visiting AP)
\vspace{-.35in}
...
\vspace{-.35in}
\paragraph{2021:} \textit{Diego Cardoso$^\Upsilon$ (U Geneva Postdoc \& Purdue Ag Econ)}; Yuanning Liang (Peking University); Lin Yang (Hong Kong University of Science and Technology)

\vspace{-.2in}
 
\subsubsection{Masters}\vspace{-.2in}
\paragraph{2026:} \textit{Xiufang Cao$^\Upsilon$ (Dartmouth Pre-Doc)}
\vspace{-.35in} 
