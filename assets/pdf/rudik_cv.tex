...
\paragraph{2022} Mines ParisTech, Toulouse School of Economics, Indiana University, University of Colorado, CESifo Area Conference on Energy and Climate Economics, Georgetown, Oregon State, Duke-NCSU-TREE, ASSA \vspace{-.2in}
...
\paragraph{Current:} \textit{Luc Esprabens}$^*$; \textit{Mike Huang}$^*$; \textit{Weiliang Tan}$^*$; Marley Bonacquist-Currin; Muye Chen; Emiliano Harris; Deyu Rao; Louis Sears; Hui Zhou
\vspace{-.4in}
