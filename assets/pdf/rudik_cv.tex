...
\paragraph{Current:} \textit{Virginia Callison}$^\Upsilon$; \textit{Luc Esprabens}$^\Upsilon$; \textit{Mike Huang}$^\Upsilon$; \textit{Tianzi Liu}$^\Upsilon$;\textit{Antonia Marcheva}$^\Upsilon$; \textit{Weiliang Tan}$^\Upsilon$; Dean Arnold; Bingyan Dai; Emiliano Harris; Yurou He; Jack Ma; Zebang Xu
\vspace{-.35in}
