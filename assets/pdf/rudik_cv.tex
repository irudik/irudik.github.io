...
\begin{itemize}
	\item[] Rudik, I. 2020. \href{https://www.aeaweb.org/articles?id=10.1257/pol.20160541}{Optimal Climate Policy When Damages are Unknown}. \textbf{American Economic Journal: Economic Policy} 12(2).
...
\begin{itemize} % Reduce space between items
	\item[] \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3086728}{Costs of Inefficient Regulation: Evidence from the Bakken} (with Gabe Lade, \textbf{conditionally accepted at JEEM})	
...
\paragraph{2020} IZA Workshop on Environment Health and Labor Markets, Penn State, NBER EEE Spring, Cornell Lab of Ornithology, ASSA (presenter, discussant) \vspace{-.3in}
...
\begin{itemize}
	...
	\vspace{-0.05in}
	\begin{itemize} \itemsep -1pt
		\item[] Marley Bonacquist-Currin - Cornell University Natural Resources Ph.D. \hfill Expected 2020
