...
\begin{itemize} % Reduce space between items
	...
	\item[] Equity and Efficiency in the Bipartisan Infrastructure Law’s Adaptation Investments (with Derek Lemoine and Antonia Marcheva)
...
\paragraph{Current:} \textit{Luc Esprabens}$^\Upsilon$;, \textit{Luc Esprabens}$^\Upsilon$; \textit{Mike Huang}$^\Upsilon$; \textit{Antonia Marcheva}$^\Upsilon$; \textit{Weiliang Tan}$^\Upsilon$; Dean Arnold; Bingyan Dai; Emiliano Harris; Yurou He; Jack Ma; Zebang Xu
\vspace{-.35in}
