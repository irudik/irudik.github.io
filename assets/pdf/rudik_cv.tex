...
\vspace{-.4in}
\paragraph{2022:} \textit{Xuquan Ma$^*$ (Berkeley Health Policy Ph.D.)}, Gemma Del Rossi (UCSB Bren Ph.D.), Ziqian Byron Song (IFPRI), Henry Williams (Colorado State DARE Ph.D.), Delta Zhang, Terry Zhang (Cornell Dyson Ph.D.)
\vspace{-.4in}
...
\paragraph{2023:} \textit{Chen-Ti Chen$^*$ (Ohio State AEDE)}

\vspace{-.2in}

\subsubsection{Undergraduate}\vspace{-.2in}
\paragraph{2023:} \textit{Alan Cui$^*$}\vspace{-.4in}
