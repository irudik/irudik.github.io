...
\paragraph{2024} NBER EEPE Conference, UC Santa Barbara, ASSA (presenter, discussant) \vspace{-.2in}
...
\paragraph{Current:} \textit{Luc Esprabens}$^\Upsilon$; \textit{Mike Huang}$^\Upsilon$; \textit{Antonia Marcheva}$^\Upsilon$; \textit{Weiliang Tan}$^\Upsilon$; Dean Arnold; Bingyan Dai; Emiliano Harris; Jack Ma; Zebang Xu
\vspace{-.35in}
