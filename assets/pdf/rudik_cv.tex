...
\paragraph{Current:} \textit{Virginia Callison}$^\Upsilon$; \textit{Chrisma D'Souza}$^\Upsilon$; \textit{Luc Esprabens}$^\Upsilon$; \textit{Tianzi Liu}$^\Upsilon$; Dean Arnold; Bingyan Dai; Victor Simoes Dornelas, Yurou He; Zhiren Hu; Tianjiao Mei; Jeisson Prieto; Zebang Xu; Terry Zhang; Yongfan Zhao
\vspace{-.35in}
\paragraph{2026:} \textit{Antonia Marcheva$^\Upsilon$ (Paris School of Economics Postdoc)}; Jack Ma (CUHK Shenzhen)
\vspace{-.35in}
