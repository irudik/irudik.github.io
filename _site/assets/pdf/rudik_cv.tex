...
\paragraph{2025} Paris School of Economics, Rochester Institute of Technology Annual Viehe Lecture Series \vspace{-.2in}
...
\paragraph{Current:} \textit{Virginia Callison}$^\Upsilon$; \textit{Luc Esprabens}$^\Upsilon$; \textit{Tianzi Liu}$^\Upsilon$;\textit{Antonia Marcheva}$^\Upsilon$; \textit{Weiliang Tan}$^\Upsilon$; Dean Arnold; Bingyan Dai; Emiliano Harris; Yurou He; Jack Ma; Zebang Xu; Yongfan Zhao
\vspace{-.35in}
\paragraph{2025:} \textit{{Mike Huang}$^\Upsilon$ (Freddie Mac)}
\vspace{-.35in}
