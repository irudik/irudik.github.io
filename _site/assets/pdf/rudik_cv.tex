...
\begin{itemize}
	\item[] Hollingsworth, A., T. Jaworski, C. Kitchens, I.Rudik. Forthcoming. \href{https://osf.io/preprints/socarxiv/x6fuw/}{Economic Geography and the Efficiency of Air Pollution Regulation in the United States}. \textbf{Journal of Political Economy: Microeconomics.}
...
\paragraph{Current:} \textit{Virginia Callison}$^\Upsilon$; \textit{Luc Esprabens}$^\Upsilon$; \textit{Mike Huang}$^\Upsilon$; \textit{Tianzi Liu}$^\Upsilon$;\textit{Antonia Marcheva}$^\Upsilon$; \textit{Weiliang Tan}$^\Upsilon$; Dean Arnold; Bingyan Dai; Emiliano Harris; Yurou He; Jack Ma; Zebang Xu; Yongfan Zhao
\vspace{-.35in}
